...
int main(int argc, char** argv) {
  ...
  splunk::OpenTelemetryOptions otelOptions =
    splunk::OpenTelemetryOptions()
      .WithServiceName("jaeger-service")
      .WithServiceVersion("1.50")
      .WithDeploymentEnvironment("test-jaeger")
      .WithExporter(splunk::ExporterType_JaegerThriftHttp)
      .WithJaegerEndpoint("http://localhost:9080/api/traces");
  ...
  opentelemetry::nostd::shared_ptr<opentelemetry::trace::Span> parentSpan =
    tracer->StartSpan("parent-op-thrift");
  ...
  opentelemetry::nostd::shared_ptr<opentelemetry::trace::Span> span =
    tracer->StartSpan("child-op-thrift", {}, startOptions);
